...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 16:24:25 2019
...
n_img = 1230  #820 #1900... doesn't find middle lane strangley
            #2370 not a lane picture
            #3450; weird only detects 2 BL
            #4050; bad lol
            #4030; discontinuity
            #4746; last real image
            #70; not real image
...
fit_lane = False
fit_free = False
MIN_LEN_R = 10 # min row length to be consitered lane marker
MAX_WIDTH = 10 # max average column width to be considered lane marker
mean_width = []
max_width = []
...
MIN_COL_SPACE = 5 # min spacing between blue lines below which considered single line
if fit_laneline:
    ...
    fit_r = np.linspace(0,95,20) # fixed spacing for building blue lines
    n_blpoint = 20 # number of coordinates in blue line
